...
enum quad_operator{ QUAD_NO_OP, QUAD_PLUS, QUAD_MINUS, QUAD_MULTIPLY, QUAD_DIVIDE, QUAD_NEG, QUAD_EQ, QUAD_NE, QUAD_GT, QUAD_LT, QUAD_GE, QUAD_LE, QUAD_NZ, QUAD_ASSIGNMENT, QUAD_INCREASE, QUAD_DECREASE, QUAD_PRINTF, QUAD_PRINTI, QUAD_ARRAY_READ, QUAD_ARRAY_WRITE};
